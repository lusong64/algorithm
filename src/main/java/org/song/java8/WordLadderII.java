...
public class WordLadderII {
    ...
    // more OOP but maybe slower
    public List<List<String>> findLadders(String start, String end, Set<String> dict) {
        List<List<String>> res = new ArrayList<List<String>>();
        Set<String> visited = new HashSet<>();
        List<String> solution = new ArrayList<>();
        dict.add(end);
        Node startNode = bfs(start, end, dict);
        dfs(startNode, end, solution, res);
        return res;
    }

    // BFS: Trace every node's distance from the start node (level by level).
    private Node bfs(String start, String end, Set<String> dict) {
        ...
        while (!queue.isEmpty()) {
            ...
            List<String> neighbors = getNeighbors(cur.s, dict);
            StringBuilder bldr = new StringBuilder("Added Child for ").append(cur).append(": ");
            for (String neighbor : neighbors) {

                boolean in = visited.containsKey(neighbor);
                Node childNode = null;
                if (!in){
                    childNode = new Node(neighbor, cur.distance+1);
                    visited.put(neighbor, childNode);
                }
                else{
                    childNode = visited.get(neighbor);
                }

                // avoid loop
                if (childNode.distance<=cur.distance){
                    continue;
                }
                cur.addChild(childNode);
                bldr.append(childNode).append(", ");
                if (!in){
    ...
    private void dfs(Node cur, String end, List<String> solution, List<List<String>> res) {
    ...
    private static void test( WordLadderII wordLadderII, String s, String e, Set<String> dict){

        System.out.println(s + "->" + e + ": " + wordLadderII.findLadders(s, e, dict));
    }
    public static void main(String[] args) {
        ...
        /*
        test(wl, "hot", "dog", new HashSet<String>(Arrays.asList("hot", "dog", "dot")));
        test(wl, "hot", "dog", new HashSet<String>(Arrays.asList("hot","cog","dog","tot","hog","hop","pot","dot")));
        */
        test(wl, "sand", "acne",
                new HashSet<String>(Arrays.asList("slit", "bunk", "wars", "ping", "viva", "wynn", "wows", "irks",
                        "gang", "pool", "mock","fort","heel","send","ship","cols","alec","foal","nabs","gaze",
                        "giza","mays","dogs","karo","cums","jedi","webb","lend","mire","jose","catt","grow",
                        "toss","magi","leis","bead","kara","hoof","than","ires","baas","vein","kari","riga",
